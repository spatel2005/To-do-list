...
- View the local installation in the [CONTRUBUTING.md](https://github.com/spatel2005).
...
Check [Issues](https://github.com/spatel2005) for contributing to this repository.
...
- View the [`CONTRIBUTING.md`](https://github.com/spatel2005) for further instructions, requirements/dependencies & local project setup instructions!
- All the contributors to this repository can be found in the [`CONTRIBUTORS.md`](https://github.com/spatel2005) file!
...
* Shivam Kumar (shivamkumar, shivamkumar@gmail.com)
